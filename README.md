# [ARMIPS assembler](https://github.com/Kingcom/armips) build for macOS [![Build Status](https://travis-ci.org/Emory-M/armips.svg?branch=v0.9)](https://travis-ci.org/Emory-M/armips)
